...
from app.routers import auth, users, jobs, applications, referrals, interviews, assessments, offers, dashboard, notifications, uploads, reports, documents, agencies, interview_slots, screening, resources
...
app.include_router(interview_slots.router, prefix=prefix)
